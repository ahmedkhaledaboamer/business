...
const colorClasses = {
  gold: {
    overlay: 'from-navy-dark/50 to-gold/40',
    bg: 'bg-gold/10',
  ...
  burgundy: {
    overlay: 'from-navy-dark/50 to-burgundy/60',
    bg: 'bg-burgundy/10',
  ...
  teal: {
    overlay: 'from-navy-dark/50 to-teal/60',
    bg: 'bg-teal/10',
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="inline-block rounded-full px-5 py-2 bg-burgundy/10 border border-burgundy/20 text-burgundy  text-[clamp(1.2rem,2vw,2rem)] mb-6 shadow-sm">
            {t('badge')}
          </span>
        ...
        >
          {[0, 1, 2, 3, 4, 5].map((index) => {
            ...
            return (
              ...
              >
                {/* Image Header */}
                <div className="relative h-60 md:h-80 lg:h-70 xl:h-80 2xl:h-120 overflow-hidden">
                  <Image
                ...
                <div className="p-8 flex-1 flex flex-col">
                  <h3 className="font-cairo font-bold text-[clamp(1rem,1.5vw,3rem)] text-navy-dark mb-4 group-hover:text-navy transition-colors">
                    {title}
                  </h3>
                  <p className=" text-[clamp(.9rem,1vw,2rem)] text-navy/60 leading-relaxed flex-1">
                    {description}
                  </p>
