          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="bg-teal-900 text-white p-10 md:p-16 relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-center  text-[clamp(0.75rem,2vw,6rem)] font-bold mb-8 text-amber-400">
                  {t('title')}
                </h3>
                <p className="text-teal-100 text-center  mb-10 text-[clamp(0.75rem,2vw,1.5rem)]">
                  {t('subtitle')}
                </p>
