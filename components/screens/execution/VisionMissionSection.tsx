      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div
            ...
            className="flex flex-col items-center justify-center md:items-start lg:justify-start bg-[#FAFAF8] rounded-2xl p-8 shadow-sm border-t-4 border-amber-500 relative overflow-hidden group hover:shadow-md transition-shadow"
          >
            <div className="absolute w-32 h-32 bg-amber-100 rounded-bl-full -z-10 opacity-50 group-hover:scale-110 transition-transform"></div>
          ...
          <motion.div
            variants={itemVariants}
            className="flex flex-col items-center justify-center md:items-start lg:justify-start bg-[#FAFAF8] rounded-2xl p-8 shadow-sm border-t-4 border-teal-500 relative overflow-hidden group hover:shadow-md transition-shadow"
          >
            <div className="absolute w-32 h-32 bg-teal-50 rounded-bl-full -z-10 opacity-50 group-hover:scale-110 transition-transform"></div>
